...
(function($){
    ...
    jQuery.dialogPlugin = {
        alert: function (str, callback, settings) {
            ...
            console.log($(el.alertDialogEl).length);
            //alert dialog html
            ...
            alertHtml += '<div class="modal-footer didi-row"><button type="button" class="didi-btn didi-btn-highlight dlg-btn J_confirmAlert" data-dismiss="modal">' + cfg["okBtn"]+ '</button></div></div></div></div>';
        ...
        confirm: function (str, okCb, cancelCb, settings) {
            ...
            console.log($(el.confirmDialogEl).length);
            //confirm dialog html
            ...
            confirmHtml += '<div class="modal-footer didi-row"><button type="button" class="didi-btn didi-btn-cancel dlg-btn J_cancelConfirm" data-dismiss="modal">'+ cfg.cancelBtn +'</button> <button type="button" class="didi-btn didi-btn-highlight dlg-btn J_acceptConfirm" data-dismiss="modal">' + cfg.okBtn + '</button> </div></div></div></div>';
