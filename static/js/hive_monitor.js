...
function sendChangeStatusAjax(ev) {
    var
...
function get_every_data_detail(dataList) {
    ...
    $.each(dataList, function(){
        ...
        // 编辑、删除
        if(this.status == 0){
            item.push('<a class="btn btn-primary btn-xs J_status margin-right-10" data-status="1" href="javascript:;">启用</a><a class="btn btn-primary btn-xs J_edit margin-right-10" href="/data_monitor/xch/hive_monitor_conf?job_id=' + this.id + '">编辑</a><a class="btn btn-danger btn-xs J_del" href="javascript:;">删除</a>');
        }else if(this.status == 1){
            item.push('<a class="btn btn-primary btn-xs J_status margin-right-10" data-status="0" href="javascript:;">停用</a><a class="btn btn-primary btn-xs J_edit margin-right-10" href="/data_monitor/xch/hive_monitor_conf?job_id=' + this.id + '">编辑</a><a class="btn btn-danger btn-xs J_del" href="javascript:;">删除</a>');
        }
        items.push(item);
    });
    render_table(items);
